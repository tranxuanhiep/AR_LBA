...
export const promotion = (item, props) => {
  ...
  return <Card style={{ flex: 0 }}>
      ...
      <CardItem>
        <Body>
          <PhotoGrid height={200} width={width * 0.9} source={listImage} onPressImage={() => {}} />
          <Text style={{ fontSize: 15, fontWeight: "bold" }}>
            {item.Promotion_Title}
          </Text>
          <Text style={{ fontSize: 15, fontWeight: "bold" }}>
            {new Date(item.Promotion_DateStart).toDateString()} -- {new Date(item.Promotion_DateEnd).toDateString()}
          </Text>
      ...
      <CardItem>
        <Left>
          <Button transparent onPress={() => {
            ...
            <Image style={{ height: 20, width: 20 }} source={item.checkFavorite ? require("../../images/TabBar/FavoriteChoose.png") : require("../../images/TabBar/FavoriteNull.png")} />
            <Text style={{ fontSize: 11 }}>
              {item.TotalFavorite} Favorite
            </Text>
          </Button>
        </Left>
        <Body>
          <Button transparent>
            <Image style={{ height: 20, width: 20 }} source={require("../../images/comment.png")} />
        ...
        <Right>
          <Button transparent onPress={() => {
            ...
            <Image style={{ height: 20, width: 20 }} source={require("../../images/share.png")} />
