...
export default class HomeMap extends React.Component {
  ...
  _handleResults() {
    if (this.state.results != "") this.props.onFetchSearch(this.state.results);
    else Toast.show("Text search not empty.", Toast.SHORT, Toast.TOP, style);
  }
