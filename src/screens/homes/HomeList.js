...
import { StyleSheet, Text, View, TouchableOpacity, Dimensions, FlatList, ScrollView, ActivityIndicator, TouchableHighlight, RefreshControl, Image } from 'react-native';
...
export default class HomeList extends React.Component {
    componentWillMount() {
        ...
        this.props.onFetchTopPromotions(9, this.props.latitude, this.props.longitude)
    }
    ...
    getImageTopPromotions = (item) => {
        ...
        return (
            <Image
                source={{ uri: link }}
                style={styles.imageTopPromotion}
            />
        )
    }
                                        ...
                                        <View>
                                            ...
                                            <View style={styles.TopcoverimageType} >
                                                <View style={styles.CoverTopimageType} >
                                                    <Image
                                                        source={
                                                            item.StoreCatalog_ID === 1 ? { uri: "https://png.icons8.com/ios/40/000000/cafe-filled.png" } :
                                                                item.StoreCatalog_ID === 2 ? { uri: "https://png.icons8.com/ios/40/000000/shirt-filled.png" } :
                                                                    item.StoreCatalog_ID === 3 ? { uri: "https://png.icons8.com/ios/40/000000/carousel-filled.png" } :
                                                                        { uri: "https://png.icons8.com/ios/40/000000/inscription-filled.png" }
                                                        }
                                            ...
                                            <View style={styles.coverTopOpenClose} >
                                                ...
                                                <Text
                                                    style={styles.textDayTopPromotion}
                                                >
                                    ...
                                    <View>
                                        ...
                                        <View style={styles.coverHeart} >
                                            <TouchableOpacity>
                                                <Image
                                                    ...
                                                    source={{ uri: "https://png.icons8.com/flat_round/40/000000/like.png" }}
                                                />
                                            </TouchableOpacity>
                                        </View>
                                        {/* Icon type */}
                                        <View style={styles.coveMainType}>
                                            ...
                                            <View style={styles.coverimageType} >
                                                <Image
                                                    source={
                                                        item.StoreCatalog_Name === "Food & Drink" ? { uri: "https://png.icons8.com/ios/40/000000/cafe-filled.png" } :
                                                            item.StoreCatalog_Name === "Fashion" ? { uri: "https://png.icons8.com/ios/40/000000/shirt-filled.png" } :
                                                                item.StoreCatalog_Name === "Entertainment place" ? { uri: "https://png.icons8.com/ios/40/000000/carousel-filled.png" } :
                                                                    { uri: "https://png.icons8.com/ios/40/000000/inscription-filled.png" }
                                                    }
